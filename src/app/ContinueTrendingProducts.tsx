...
const ContinueTrendingProducts = () => {
  return (
    <div className='flex justify-center gap-8'>
      <div className='bg-banner w-[340px] '>
        <p className='text-color font-bold mt-9 ml-11'>23% off in all products</p>
        <p className='text-pink-700  mt-2 ml-11'> Shoe Now</p>
        <img src="/image 1162.png" alt=""  className='ml-40 -mt-7'/>
      </div>
      <div className='bg-banner w-[340px] h-[270px]'>
        <p className='text-color font-bold  mt-9 ml-11'>23% off in all products</p>
        <p className='text-pink-700  mt-2 ml-11'> Shoe Now</p>
...
<div className='flex gap-2' >
    ...
    <p className='mt-5 ml-3'>Executive Seat chair
    $32.00</p>
</div>
<div className='flex'>
